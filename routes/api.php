...
Route::middleware('auth:sanctum')->group(function () {
    ...
    Route::post('users/{user}/favorite', [FavoriteController::class, 'storeUser'])->name('favorites.store.user');
    Route::delete('users/{user}/favorite', [FavoriteController::class, 'destroyUser'])->name('favorites.destroy.user');
});
